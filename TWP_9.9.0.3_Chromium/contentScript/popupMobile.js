  ...
  popupMobile.show = function (forceShow = false) {
    ...
    getElemById("btnTranslateSelectedText").onclick = e => {
      if (twpConfig.get("showTranslateSelectedButton") === "yes") {
        ...
        getElemById("btnTranslateSelectedText").textContent = twpI18n.getMessage("msgTranslateSelectedText");
      } else {
        twpConfig.set("showTranslateSelectedButton", "yes");
        getElemById("btnTranslateSelectedText").textContent = twpI18n.getMessage("msgNoTranslateSelectedText");
      }
      getElemById("menu").style.display = "none";
      e.stopPropagation();
    };
...
//# sourceMappingURL=https://raw.githubusercontent.com/FilipePS/TWP---Source-Maps/main/maps/9.9.0.3/popupMobile.js.map
