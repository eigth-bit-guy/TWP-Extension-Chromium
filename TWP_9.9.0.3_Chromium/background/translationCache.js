...
const translationCache = function (_class) {
  ...
  async function _queryInDB2(origTextHash) {
    return await new Promise((resolve, reject) => {
      ...
      const storageName = _class.getCacheStorageName();
...
//# sourceMappingURL=https://raw.githubusercontent.com/FilipePS/TWP---Source-Maps/main/maps/9.9.0.3/translationCache.js.map
