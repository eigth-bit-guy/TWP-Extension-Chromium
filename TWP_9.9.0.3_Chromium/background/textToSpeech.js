...
const textToSpeech = function () {
  ...
  class BingHelper {
    static get IG() {
      return _classStaticPrivateFieldSpecGet(BingHelper, BingHelper, _IG);
    }
    static get IID() {
      return _classStaticPrivateFieldSpecGet(BingHelper, BingHelper, _IID);
    }
    static get key() {
      return _classStaticPrivateFieldSpecGet(BingHelper, BingHelper, _key);
    }
    static get token() {
      return _classStaticPrivateFieldSpecGet(BingHelper, BingHelper, _token);
    }
    ...
    static async findAuth() {
      if (_classStaticPrivateFieldSpecGet(BingHelper, BingHelper, _promise)) return await _classStaticPrivateFieldSpecGet(BingHelper, BingHelper, _promise);
      _classStaticPrivateFieldSpecSet(BingHelper, BingHelper, _promise, new Promise(resolve => {
        let updateBingAuth = false;
        if (_classStaticPrivateFieldSpecGet(BingHelper, BingHelper, _lastRequestTime)) {
          const date = new Date();
          if (_classStaticPrivateFieldSpecGet(BingHelper, BingHelper, _IG)) {
            date.setMinutes(date.getMinutes() - 30);
          } else if (_classStaticPrivateFieldSpecGet(BingHelper, BingHelper, _notFound)) {
            date.setMinutes(date.getMinutes() - 5);
          } else {
            date.setMinutes(date.getMinutes() - 2);
          }
          if (date.getTime() > _classStaticPrivateFieldSpecGet(BingHelper, BingHelper, _lastRequestTime)) {
            updateBingAuth = true;
          }
        } else {
          updateBingAuth = true;
        ...
        if (updateBingAuth) {
          _classStaticPrivateFieldSpecSet(BingHelper, BingHelper, _lastRequestTime, Date.now());
          ...
          http.onload = e => {
            try {
              ...
              const key = abh[0];
              const token = abh[1];
              _classStaticPrivateFieldSpecSet(BingHelper, BingHelper, _IG, IG);
              _classStaticPrivateFieldSpecSet(BingHelper, BingHelper, _IID, IID);
              _classStaticPrivateFieldSpecSet(BingHelper, BingHelper, _key, key);
              _classStaticPrivateFieldSpecSet(BingHelper, BingHelper, _token, token);
              _classStaticPrivateFieldSpecSet(BingHelper, BingHelper, _notFound, false);
            } catch (e) {
              _classStaticPrivateFieldSpecSet(BingHelper, BingHelper, _notFound, true);
            } finally {
              resolve();
            }
          };
      ...
      _classStaticPrivateFieldSpecGet(BingHelper, BingHelper, _promise).finally(() => {
        _classStaticPrivateFieldSpecSet(BingHelper, BingHelper, _promise, null);
      });
      return await _classStaticPrivateFieldSpecGet(BingHelper, BingHelper, _promise);
    }
...
//# sourceMappingURL=https://raw.githubusercontent.com/FilipePS/TWP---Source-Maps/main/maps/9.9.0.3/textToSpeech.js.map
